    ...
    , model(new StatisticsModel(configController.getStatisticsConfig(), this))
{
    ...
    connect(ui->treeView, &QTreeView::clicked
            , this, &StatisticsWidget::updateEnables);
    ...
    connect(ui->removeButton, &QPushButton::clicked
            , this, &StatisticsWidget::removeSelectedConfigTreeElement);
...
void StatisticsWidget::updateEnables(const QModelIndex &index)
{
...
void StatisticsWidget::addStatisticsConfigElement()
{
...
void StatisticsWidget::removeSelectedConfigTreeElement()
{
    auto index = ui->treeView->selectionModel()->currentIndex();
    auto type = model->getType(index);
    auto configElement = model->getTreeElement(index);
